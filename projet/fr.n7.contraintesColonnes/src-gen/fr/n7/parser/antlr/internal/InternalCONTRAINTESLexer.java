...
public class InternalCONTRAINTESLexer extends Lexer {
    ...
    public final void mT__12() throws RecognitionException {
        try {
            ...
            // InternalCONTRAINTES.g:11:7: ( 'contrainte' )
            // InternalCONTRAINTES.g:11:9: 'contrainte'
            {
            match("contrainte"); 
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:17:7: ( '}' )
            // InternalCONTRAINTES.g:17:9: '}'
            {
            match('}'); 
    ...
    public final void mT__19() throws RecognitionException {
        try {
            int _type = T__19;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:18:7: ( 'valeur' )
            // InternalCONTRAINTES.g:18:9: 'valeur'
            {
            match("valeur"); 
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:19:7: ( '<' )
            // InternalCONTRAINTES.g:19:9: '<'
            {
            match('<'); 
    ...
    public final void mT__25() throws RecognitionException {
        try {
            int _type = T__25;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:24:7: ( 'et' )
            // InternalCONTRAINTES.g:24:9: 'et'
            {
            match("et"); 
    ...
    public final void mT__26() throws RecognitionException {
        try {
            int _type = T__26;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:25:7: ( 'ou' )
            // InternalCONTRAINTES.g:25:9: 'ou'
            {
            match("ou"); 
    ...
    public final void mT__27() throws RecognitionException {
        try {
            int _type = T__27;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:26:7: ( '!' )
            // InternalCONTRAINTES.g:26:9: '!'
            {
            match('!'); 
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:610:12: ( ( '-' | '+' )? RULE_INT ( '.' RULE_INT )? )
            // InternalCONTRAINTES.g:610:14: ( '-' | '+' )? RULE_INT ( '.' RULE_INT )?
            {
            // InternalCONTRAINTES.g:610:14: ( '-' | '+' )?
            int alt1=2;
            ...
            mRULE_INT(); 
            // InternalCONTRAINTES.g:610:34: ( '.' RULE_INT )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalCONTRAINTES.g:610:35: '.' RULE_INT
                    {
                    match('.'); 
                    mRULE_INT(); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:612:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalCONTRAINTES.g:612:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalCONTRAINTES.g:612:11: ( '^' )?
            int alt3=2;
            ...
            // InternalCONTRAINTES.g:612:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalCONTRAINTES.g:614:19: ( ( '0' .. '9' )+ )
            // InternalCONTRAINTES.g:614:21: ( '0' .. '9' )+
            {
            // InternalCONTRAINTES.g:614:21: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalCONTRAINTES.g:614:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:616:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalCONTRAINTES.g:616:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalCONTRAINTES.g:616:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalCONTRAINTES.g:616:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalCONTRAINTES.g:616:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalCONTRAINTES.g:616:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalCONTRAINTES.g:616:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:618:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalCONTRAINTES.g:618:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalCONTRAINTES.g:618:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:620:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalCONTRAINTES.g:620:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalCONTRAINTES.g:620:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
            ...
            // InternalCONTRAINTES.g:620:40: ( ( '\\r' )? '\\n' )?
            int alt12=2;
            ...
            switch (alt12) {
                case 1 :
                    // InternalCONTRAINTES.g:620:41: ( '\\r' )? '\\n'
                    {
                    // InternalCONTRAINTES.g:620:41: ( '\\r' )?
                    int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:622:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalCONTRAINTES.g:622:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalCONTRAINTES.g:622:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalCONTRAINTES.g:624:16: ( . )
            // InternalCONTRAINTES.g:624:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_eotS =
        "\1\uffff\1\31\6\uffff\1\31\1\42\1\44\1\uffff\2\31\1\uffff\1\27\1\uffff\1\27\1\uffff\3\27\2\uffff\1\31\7\uffff\1\31\5\uffff\1\60\1\61\6\uffff\2\31\2\uffff\5\31\1\71\1\31\1\uffff\2\31\1\75\1\uffff";
    static final String DFA14_eofS =
        "\76\uffff";
    static final String DFA14_minS =
        "\1\0\1\157\6\uffff\1\141\2\75\1\uffff\1\164\1\165\1\uffff\1\60\1\uffff\1\101\1\uffff\2\0\1\52\2\uffff\1\156\7\uffff\1\154\5\uffff\2\60\6\uffff\1\164\1\145\2\uffff\1\162\1\165\1\141\1\162\1\151\1\60\1\156\1\uffff\1\164\1\145\1\60\1\uffff";
    static final String DFA14_maxS =
        "\1\uffff\1\157\6\uffff\1\141\2\75\1\uffff\1\164\1\165\1\uffff\1\71\1\uffff\1\172\1\uffff\2\uffff\1\57\2\uffff\1\156\7\uffff\1\154\5\uffff\2\172\6\uffff\1\164\1\145\2\uffff\1\162\1\165\1\141\1\162\1\151\1\172\1\156\1\uffff\1\164\1\145\1\172\1\uffff";
    static final String DFA14_acceptS =
        "\2\uffff\1\2\1\3\1\4\1\5\1\6\1\7\3\uffff\1\15\2\uffff\1\20\1\uffff\1\21\1\uffff\1\22\3\uffff\1\26\1\27\1\uffff\1\22\1\2\1\3\1\4\1\5\1\6\1\7\1\uffff\1\12\1\11\1\14\1\13\1\15\2\uffff\1\20\1\21\1\23\1\24\1\25\1\26\2\uffff\1\16\1\17\7\uffff\1\10\3\uffff\1\1";
    static final String DFA14_specialS =
        "\1\0\22\uffff\1\1\1\2\51\uffff}>";
    static final String[] DFA14_transitionS = {
            "\11\27\2\26\2\27\1\26\22\27\1\26\1\16\1\23\4\27\1\24\1\2\1\4\1\27\1\17\1\3\1\17\1\27\1\25\12\20\1\27\1\6\1\11\1\13\1\12\2\27\32\22\3\27\1\21\1\22\1\27\2\22\1\1\1\22\1\14\11\22\1\15\6\22\1\10\4\22\1\5\1\27\1\7\uff82\27",
            "\1\30",
            "",
            "",
            "",
