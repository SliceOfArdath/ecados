...
public class AlgorithmeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case AlgorithmePackage.EXPRESSION: {
		...
		case AlgorithmePackage.OPERATION: {
		...
		case AlgorithmePackage.OPERATION_BINAIRE: {
			...
			if (result == null)
				result = caseExpression(operationBinaire);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AlgorithmePackage.OPERATION_UNAIRE: {
			...
			if (result == null)
				result = caseExpression(operationUnaire);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case AlgorithmePackage.CONSTANTE: {
			...
			if (result == null)
				result = caseExpression(constante);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
