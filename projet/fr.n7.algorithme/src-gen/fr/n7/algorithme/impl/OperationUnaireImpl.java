 ...
 * </p>
 * <ul>
 *   <li>{@link fr.n7.algorithme.impl.OperationUnaireImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OperationUnaireImpl extends ExpressionImpl implements OperationUnaire {
	...
	protected EClass eStaticClass() {
		return AlgorithmePackage.Literals.OPERATION_UNAIRE;
	}
			...
			if (expression != oldExpression) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							AlgorithmePackage.OPERATION_UNAIRE__EXPRESSION, oldExpression, expression));
			}
		}
		return expression;
	}
	...
	public void setExpression(Expression newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlgorithmePackage.OPERATION_UNAIRE__EXPRESSION,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AlgorithmePackage.OPERATION_UNAIRE__EXPRESSION:
			if (resolve)
