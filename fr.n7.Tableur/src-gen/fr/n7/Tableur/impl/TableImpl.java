 ...
 *   <li>{@link fr.n7.Tableur.impl.TableImpl#getNom <em>Nom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends MinimalEObjectImpl.Container implements Table {
	...
	public EList<Colonne> getColonnes() {
		if (colonnes == null) {
			colonnes = new EObjectContainmentEList<Colonne>(Colonne.class, this, TableurPackage.TABLE__COLONNES);
		}
		return colonnes;
	}
	...
	public void setNom(String newNom) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TableurPackage.TABLE__NOM, oldNom, nom));
	}
