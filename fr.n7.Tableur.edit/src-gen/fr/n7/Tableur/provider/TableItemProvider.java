...
public class TableItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						TableurPackage.Literals.TABLE__NOM, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TableurPackage.Literals.TABLE__COLONNES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case TableurPackage.TABLE__NOM:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TableurPackage.Literals.TABLE__COLONNES,
				TableurFactory.eINSTANCE.createDonneeBrute()));

		newChildDescriptors.add(createChildParameter(TableurPackage.Literals.TABLE__COLONNES,
				TableurFactory.eINSTANCE.createDonneeCalculee()));
	}
